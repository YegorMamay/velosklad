    ...
    <div class="col-xs-12 col-md-8">
        ...
        <?php if (have_posts()) { ?>
            <div class="review-list">
                                    ...
                                    <?php if (count($social)) { ?>
                                        <a class="review-social" href="<?php echo esc_url($social['url']); ?>"
                                           target="_blank" rel="noopener noreferrer">
                                            <i class="fa <?php echo esc_attr($social['icon']); ?>"
                                               aria-hidden="true"></i>
                                        </a>
                                    <?php } ?>
                                </div>
                ...
                <?php } ?>
                <?php brainworks_pagination(); ?>
            </div>
        <?php } else {
            get_template_part('loops/content', 'none');
        } ?>
    </div>
    <div class="col-xs-12 col-md-4"><?php if (function_exists("add_formcraft_form")) { add_formcraft_form("[fc id='6'][/fc]"); } ?></div>
</div>
