...
?>
<form role="search" method="get" class="form-inline navbar-form woocommerce-product-search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
    ...
    <button class="btn-search" type="submit" value="<?php echo esc_attr_x( 'Search', 'submit button', 'woocommerce' ); ?>">
        <span class="screen-reader-text"><?php echo esc_attr_x( 'Search', 'submit button', 'woocommerce' ); ?></span>
        <i class="fa fa-search reversed-color"></i>
    </button>
